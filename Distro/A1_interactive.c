...
#include "MDB-c_1006280917.c"  // <--- This will import your code so we can
...
int main()
{
    ...
    while (cont)
    {
		...
		/* MDB_head = insertMovieReview("a","asd",1998,12,1, MDB_head);
		MDB_head = insertMovieReview("b","asd",1999,121,2, MDB_head);
		MDB_head = insertMovieReview("z","asd",2000,1212,6, MDB_head); */
